...
const messages: Record<Language, Record<string, string>> = {
  zh_CN: {
    ...
    beautify_bg_border_radius: "背景圆角",
    beautify_toggle_on: "开启",
    beautify_toggle_off: "关闭",
    ...
    info_loading: "读取中…",
    info_error: "读取信息失败",
    info_basic_section: "基本信息",
    info_exif_section: "EXIF 拍摄参数",
    info_url: "图片地址",
    info_format: "图片格式",
    info_dimensions: "图片尺寸",
    info_file_size: "文件大小",
    info_mime_type: "MIME 类型",
    info_copy_url: "复制地址",
    info_unknown: "未知",
    exif_title: "EXIF 信息",
    exif_loading: "读取中…",
    ...
    // 显示策略相关
    popup_strategy_title: "显示策略",
    strategy_open_all: "全局打开 (忽略黑名单)",
    strategy_close_all: "全局关闭 (忽略白名单)",
    strategy_close_with_whitelist: "默认关闭 (白名单站点打开)",
    strategy_open_with_blacklist: "默认打开 (黑名单站点关闭)",
    popup_site_whitelist: "白名单",
    popup_site_blacklist: "黑名单",
    site_add_whitelist: "加入白名单",
    site_remove_whitelist: "移除白名单",
    site_add_blacklist: "加入黑名单",
    site_remove_blacklist: "移除黑名单",
    site_status_active: "已启用",
    site_status_inactive: "已禁用",
    context_menu_add_whitelist: "将当前站点加入白名单",
    context_menu_add_blacklist: "将当前站点加入黑名单",
    site_list_whitelist_title: "白名单",
    site_list_blacklist_title: "黑名单",
    site_list_empty_whitelist: "暂无白名单站点",
    site_list_empty_blacklist: "暂无黑名单站点",
    site_list_add_placeholder: "输入域名，如 example.com",
    site_list_add_btn: "添加",
    site_list_conflict_whitelist: "该域名已在白名单中，已自动移除",
    site_list_conflict_blacklist: "该域名已在黑名单中，已自动移除",
    site_list_invalid_domain: "请输入有效域名",
  },
  en: {
    extension_name: "SnapLab",
    extension_description:
      "A web assistant plugin including image preview, zoom, rotate, and other image processing related functions.",
    ...
    beautify_bg_border_radius: "Bg Radius",
    beautify_toggle_on: "Enable",
    beautify_toggle_off: "Disable",
    ...
    info_error: "Failed to load info",
    info_basic_section: "Basic Info",
    info_exif_section: "EXIF Parameters",
    info_url: "Image URL",
    info_format: "Format",
    info_dimensions: "Dimensions",
    info_file_size: "File Size",
    info_mime_type: "MIME Type",
    info_copy_url: "Copy URL",
    ...
    // Display strategy
    popup_strategy_title: "Display Strategy",
    strategy_open_all: "Global Open (Ignore Blacklist)",
    strategy_close_all: "Global Close (Ignore Whitelist)",
    strategy_close_with_whitelist: "Default Close (Whitelist Active)",
    strategy_open_with_blacklist: "Default Open (Blacklist Active)",
    popup_site_whitelist: "Whitelist",
    popup_site_blacklist: "Blacklist",
    site_add_whitelist: "Add to Whitelist",
    site_remove_whitelist: "Remove Whitelist",
    site_add_blacklist: "Add to Blacklist",
    site_remove_blacklist: "Remove Blacklist",
    site_status_active: "Active",
    site_status_inactive: "Inactive",
    context_menu_add_whitelist: "Add current site to Whitelist",
    context_menu_add_blacklist: "Add current site to Blacklist",
    site_list_whitelist_title: "Whitelist",
    site_list_blacklist_title: "Blacklist",
    site_list_empty_whitelist: "No whitelist sites",
    site_list_empty_blacklist: "No blacklist sites",
    site_list_add_placeholder: "Enter domain, e.g. example.com",
    site_list_add_btn: "Add",
    site_list_conflict_whitelist: "Domain was in whitelist, auto removed",
    site_list_conflict_blacklist: "Domain was in blacklist, auto removed",
    site_list_invalid_domain: "Please enter a valid domain",
  },
};
